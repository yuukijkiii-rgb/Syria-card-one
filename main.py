...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* ======================================================== */
        /* ستايل واجهتي تسجيل الدخول وإنشاء حساب (ملء الشاشة داكن) */
        /* ======================================================== */
...
<body>
    ...
    <!-- ======================================================== -->
    <!-- 2. نافذة إنشاء حساب جديد (Register Modal)                 -->
    <!-- ======================================================== -->
    ...
    <script>
        ...
        async function handleModalLogin() {
            ...
            if (!email || !password) {
                alert('يرجى كتابة البريد الإلكتروني وكلمة السر!');
                return;
            }
            
            await loginUser(email, "0000000000", password);
            closeAuthModal();
        }
